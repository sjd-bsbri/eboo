          ...
          <Grid container sx={{ display: "flex", height: "100%" }}>
            ...
            >
              ...
              >
                ...
                >
                  انجام سفارشات ساخت پاورپوینت جهت ارائه در جلسات و کلاس های
                  درسی با جدیدترین انیمیشن به همراه خلاصه سازی متن، طراحی جداول
                  حرفه ای اکسل به همراه فرمولسازی توسط متخصصین با تجربه{" "}
                </Typography>
              </Box>
                ...
                >
                  <Grid xs={6} sm={6} md={6} lg={6} xl={6} sx={{ pr: "15px" }}>
                    ...
                    >
                      ...
                      {powerpointServiceSubject.map((input, index) => (
                        <option
...
export default PowerpointServices;
